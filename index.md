...
# Data Analysis for Continuous Improvement - Collaborative Effort and Beginner Support Materials
...
Analysis beings with ideation. Ideation draws on the experiences of a student at the end of their COMP 110 semester to provide possible changes that will be narrowed down and refined as data is analyzed. For the sake of improvment, five key ideas were noted:

1. **Additional post-lecture writing questions** - Providing additional function writing questions after lectures, especially for difficult topics, can help to solidfiy understanding and provide greater opportunity for quiz preparation.

2. **Opportunities for collaborative effort** - Allowing students to work in pairs or small groups on exercises promotes the exchange of ideas and facilitates conceptual thinking, increasing critical thinking and furthering course concept mastery.

3. **Increased beginner support materials** - Improving access to optional beginner support materials allows students with less experience narrow the skill delta between peers and foster better success in the course.

4. **Increased feetback opportunities** - Mid-semester feedback opportunities could allow instructors to adjust course material and style to better meet student needs while also gauging general concept understanding.

5. **Recorded lectures** - Providing lecture recordings could allow students who were not able to attend lecture to better understand conceptual nuances and coding processes that are missed by just following off a given slide deck.
...
A proposed method for adressing this missing data is to include survey questions regarding collaboration on work either early in the semester or sporadically thoughout the semester as new (and more difficult) topics are introduced. Survey questions could be easily included in asynchronous lesson responses on Gradescope and could measure how often students work with others and how helpful they find collaboration.
